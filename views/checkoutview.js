exports.build = function (title, content) {
    ...
    <head>
        <title>New ShopS a E-Commerce Online Shopping Category Flat Bootstrap Responsive Website Template | Checkout ::
            w3layouts</title>
        <!--css-->
    ...
    <body>
                ...
                <div class="container">
                    ...
                    <div class="top-right">
                        <ul>
                            ...
                            <li><a href="/clear"> Clear bag </a></li>
                        </ul>
                    </div>
        ...
        <div class="banner1">
            <div class="container">
                <h3><a href="/allguest">Home</a> / <span>Checkout</span></h3>
            </div>
        </div>
        <!--banner-->
        ...
        <div class="content">
            <div class="cart-items">
                <div class="container">
                    ...
                    <script>
                    if (typeof(localStorage.sepet) !== "undefined")
                    {
                    var x=JSON.parse(localStorage.getItem('sepet'));
                    var z=JSON.parse(localStorage.getItem('sepet'));
                   
                    
                    
                     document.write(x.product);
                     document.write('<br>');
                     document.write(y.product);
