exports.build = function (title, content) {
    ...
    <head>
        <title>New Shop a E-Commerce Online Shopping Category Flat Bootstrap Responsive Website Template | Products1 ::
            w3layouts</title>
        <!--css-->
...
function urunkaydet()
    {
        localStorage.setItem("sepet", JSON.stringify(urun1));

        var urunbir = JSON.parse(localStorage.getItem('urun1'));
        urunbir.piece--;
        localStorage.setItem("urun1", JSON.stringify(urunbir));
...
<script>
        var urun1 = { gender: "men", piece: "3", product: "bandana", pno: "1" };
        var urun2 = { gender: "men", piece: "4", product: "blacksweatshirt", pno: "1.2" };
        var urun3 = { gender: "men", piece: "66", product: "shirt", pno: "1.3" };
        var urun4 = { gender: "men", piece: "22", product: "bag", pno: "1.4" };
        var urun5 = { gender: "men", piece: "11", product: "shoes", pno: "1.5" };
        var urun6 = { gender: "men", piece: "34", product: "watch", pno: "1.6" };
    
        localStorage.setItem("urun1", JSON.stringify(urun1));
        localStorage.setItem("urun2", JSON.stringify(urun2));
        localStorage.setItem("urun3", JSON.stringify(urun3));
        localStorage.setItem("urun4", JSON.stringify(urun4));
        localStorage.setItem("urun5", JSON.stringify(urun5));
        localStorage.setItem("urun6", JSON.stringify(urun6));
    ...
    <body onload="init()">
                            ...
                            <nav class="navbar navbar-default">
                                ...
                                <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                                    <ul class="nav navbar-nav">
                                        <li class="active"><a href="/allguest" class="act">Home</a></li>
                                        <!-- Mega Menu -->
                                        <li class="dropdown">
        ...
        <div class="banner1">
            <div class="container">
                <h3><a href="/allguest">Home</a> / <span>Products</span></h3>
            </div>
        </div>
        <!--banner-->
        <!--content-->
                ...
                <div class="container">
                    <div class="product-agileinfo-grids w3l">
                        ...
                        <div class="col-md-9 product-agileinfon-grid1">
                                            ...
                                            <div class="product-tab">
                                                <div class="col-md-4 product-tab-grid simpleCart_shelfItem">
                                                    <div class="grid-arr">
                                                        ...
                                                        <div class="women">
                                                            ...
                                                            var urunbir = JSON.parse(localStorage.getItem('urun1'));
                                                            document.write(urunbir.product);
                                                            ...
                                                            document.write('<br>');
                                                            document.write(urunbir.piece);
                                                            document.write('<br>');
                                                            document.write(urunbir.gender);
                                                            localStorage.setItem("urun1", JSON.stringify(urunbir));
                                                ...
                                                <div class="col-md-4 product-tab-grid simpleCart_shelfItem">
                                                    <div class="grid-arr">
                                                        ...
                                                        <div class="women">
                                                            <h6><a href="/single"><script>
                                                            document.write(urun2.product);
                                                        </script></a></h6>
                                                            <span class="size"><center><script>
                                                            document.write('<br>');
                                                            document.write(urun2.piece);
                                                            document.write('<br>');
                                                            document.write(urun2.gender);
                                                ...
                                                <div class="col-md-4 product-tab-grid simpleCart_shelfItem">
                                                    <div class="grid-arr">
                                                        ...
                                                        <div class="women">
                                                            <h6><a href="/single"><script>
                                                            document.write(urun3.product);
                                                        </script></a></h6>
                                                            <span class="size"><center><script>
                                                            document.write('<br>');
                                                            document.write(urun3.piece);
                                                            document.write('<br>');
                                                            document.write(urun3.gender);
                                           ...
                                           <div class="product-tab prod1">
                                                <div class="col-md-4 product-tab-grid simpleCart_shelfItem">
                                                    <div class="grid-arr">
                                                        ...
                                                        <div class="women">
                                                            <h6><a href="/single"><script>
                                                            document.write(urun4.product);
                                                        </script></a></h6>
                                                            <span class="size"><center><script>
                                                            document.write('<br>');
                                                            document.write(urun4.piece);
                                                            document.write('<br>');
                                                            document.write(urun4.gender);
                                                ...
                                                <div class="col-md-4 product-tab-grid simpleCart_shelfItem">
                                                    <div class="grid-arr">
                                                        ...
                                                        <div class="women">
                                                            <h6><a href="/single"><script>
                                                            document.write(urun5.product);
                                                        </script></a></h6>
                                                            <span class="size"><center><script>
                                                            document.write('<br>');
                                                            document.write(urun5.piece);
                                                            document.write('<br>');
                                                            document.write(urun5.gender);
                                                ...
                                                <div class="col-md-4 product-tab-grid simpleCart_shelfItem">
                                                    <div class="grid-arr">
                                                        ...
                                                        <div class="women">
                                                            <h6><a href="single.html"><script>
                                                            document.write(urun6.product);
                                                        </script></a></h6>
                                                            <span class="size"><center><script>
                                                            document.write('<br>');
                                                            document.write(urun6.piece);
                                                            document.write('<br>');
                                                            document.write(urun6.gender);
                            ...
                            <script>var veri1 = JSON.parse(localStorage.getItem('verii'));</script>
                            <div id="content">
                            if(veri1==1){content}</div>
                        </div>
                        <div class="clearfix"> </div>
                    </div>
                </div>
