                            ...
                            <div class="col-md-4 product-grid">
                                <div id="owl-demo" class="owl-carousel">
                                    <div class="item">
                                        <div class="recent-grids">
                                            <div class="recent-left">
                                                <a href="/single"><img class="img-responsive " src="images/r.jpg"
                                                        alt=""></a>
                                            </div>
                                            <div class="recent-right">
                                                <h6 class="best2"><a href="/single">Lorem ipsum dolor </a></h6>
                                        ...
                                        <div class="recent-grids">
                                            <div class="recent-left">
                                                <a href="/single"><img class="img-responsive " src="images/r1.jpg"
                                                        alt=""></a>
                                            </div>
                                            <div class="recent-right">
                                                <h6 class="best2"><a href="/single">Duis aute irure </a></h6>
                                        ...
                                        <div class="recent-grids">
                                            <div class="recent-left">
                                                <a href="/single"><img class="img-responsive " src="images/r2.jpg"
                                                        alt=""></a>
                                            </div>
                                            <div class="recent-right">
                                                <h6 class="best2"><a href="/single">Lorem ipsum dolor </a></h6>
                                        ...
                                        <div class="recent-grids">
                                            <div class="recent-left">
                                                <a href="/single"><img class="img-responsive " src="images/r3.jpg"
                                                        alt=""></a>
                                            </div>
                                            <div class="recent-right">
                                                <h6 class="best2"><a href="/single">Ut enim ad minim </a></h6>
                                    ...
                                    <div class="item">
                                        <div class="recent-grids">
                                            <div class="recent-left">
                                                <a href="/single"><img class="img-responsive " src="images/r4.jpg"
                                                        alt=""></a>
                                            </div>
                                            <div class="recent-right">
                                                <h6 class="best2"><a href="/single">Lorem ipsum dolor </a></h6>
                                        ...
                                        <div class="recent-grids">
                                            <div class="recent-left">
                                                <a href="/single"><img class="img-responsive " src="images/r5.jpg"
                                                        alt=""></a>
                                            </div>
                                            <div class="recent-right">
                                                <h6 class="best2"><a href="/single">Duis aute irure </a></h6>
                                    ...
                                    <div class="bs-example bs-example-tabs" role="tabpanel"
                                        ...
                                        <ul id="myTab" class="nav nav-tabs left-tab" role="tablist">
                                            ...
                                            <li role="presentation"><a href="#reviews" role="tab" id="reviews-tab"
                                                    data-toggle="tab" aria-controls="reviews">Reviews (1)</a></li>
